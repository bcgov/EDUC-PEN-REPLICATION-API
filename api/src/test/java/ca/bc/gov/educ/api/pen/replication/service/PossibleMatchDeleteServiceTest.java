 ...
 */
public class PossibleMatchDeleteServiceTest extends BasePenReplicationAPITest {
  ...
  RestUtils restUtils;
  @Autowired
  private PossibleMatchDeleteService possibleMatchDeleteService;
   ...
   */
  @Test
  public void testProcessEvent_givenDELETE_POSSIBLE_MATCH_EventAndTransactionPartOfSaga_shouldNotSaveInDB() throws JsonProcessingException {
    ...
    final var event = TestUtils.createEvent(EventType.DELETE_POSSIBLE_MATCH.toString(), request, this.penReplicationTestUtils.getEventRepository());
    this.possibleMatchDeleteService.processEvent(request, event);
